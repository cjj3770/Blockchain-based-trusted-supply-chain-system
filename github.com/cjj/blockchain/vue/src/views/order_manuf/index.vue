<template>
    <div class="app-container">
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="143px">
        ...
        methods: {
            ...
            getList() {
                ...
                listOrder().then(response => {
                    ...
                    { 
                        if (response[i].manufacturerUserAccountId==this.accountId)
                        {
            ...
            handleQuery() {
                ...
                if (this.queryParams.orderId==undefined)
                {
                this.loading = true
                this.orderList=[]
                listOrder().then(response => {
                    ...
                    { 
                        ...
                        getOrder({"storeUserAccountId":this.queryParams.storeUserAccountId,"orderId":this.queryParams.orderId,"manufacturerUserAccountId":this.accountId}).then(response => {
